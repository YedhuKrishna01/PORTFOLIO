...
function HomeBody() {
  return (
    <div className="flex flex-col justify-center items-center gap-y-9 tablet:gap-y-10 mt-2 tablet:mt-7 laptop:mt-1 text-white">
      <div className="bg-zinc-950 w-10/12 laptop:w-9/12 desktop:w-8/12 tv:w-6/12 p-5 tablet:p-7 laptop:p-11 h-36 tablet:h-56 laptop:h-64 desktop:h-56 rounded-lg">
        <div className="text-3xl tablet:text-6xl laptop:text-7xl desktop:text-5xl mb-3 tablet:mb-6 flex flex-col font-semibold">
          <div className="text-sm tablet:text-lg font-light">Hello! I'm</div>
          Yedhukrishna
        </div>
        <Link
          to="/MyWorks"
          className="font-audio text-sm tablet:text-2xl laptop:text-xl desktop:text-base hover:bg-red active:bg-red rounded-lg px-4 py-2 tablet:px-6 tablet:py-3 desktop:px-4 desktop:py-2"
      ...
      <div className="bg-zinc-950 w-10/12 laptop:w-9/12 desktop:w-8/12 tv:w-6/12 p-5 tablet:p-8 laptop:p-12 laptop:mb-8 rounded-lg">
        <div className="font-audio tablet:text-3xl desktop:text-2xl tablet:mb-3 laptop:mb-0">
          About me
        </div>
        ...
        <div className="text-xs tablet:text-lg laptop:text-xl desktop:text-lg text-justify mt-1">
